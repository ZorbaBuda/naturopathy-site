...
import Logo from "@/public/assets/parolanaudiere-logoblanc.svg";
        ...
        <div className="flex flex-col">
          ...
          <div className="grid grid-cols-1 lg:grid-rows-3  gap-5">
            ...
            <div>
              ...
              <Link href={fAddresse.mapsAddress} legacyBehavior passHref className="">{fAddresse.mapsLegend}</Link>
            </div>
            {/* nous joindre */}
            <div>
