    ...
    <section className="section-light">
        <div className="subcontainerXl flex flex-col  gap-x-5">
            {servicesDetail.map((service,i) => (
                <div id={service.id} key={i} className="pt-[85px] lg:pt-[105px] border-2 border-black flex flex-col-reverse gap-10 items-center lg:flex-row lg:even:flex-row-reverse">
                    ...
                    <div  className="h4 flex flex-wrap font-semibold  text-green2 max-w-fit mb-5">{service.title}</div>
