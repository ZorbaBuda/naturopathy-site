...
export const servicesDetail = [
  {
    ...
    text: `La nutrició i dietètica se centren en com els aliments afecten la nostra salut i benestar. La nutrició estudia els nutrients que necessitem com carbohidrats, proteïnes, greixos, vitamines i minerals, i com aquests influeixen en el nostre cos. D'altra banda, la dietètica s'enfoca en l'aplicació pràctica d'aquesta informació, ajudant les persones a planificar dietes equilibrades i saludables segons les seves necessitats individuals, ja sigui per a mantenir un pes adequat, millorar la salut o tractar condicions específiques. Totes dues disciplines són fonamentals per a promoure una vida saludable a través d'una alimentació adequada.`,
  },
  {
    image: service2,
    title: `Terapia ortomolecular`,
    text: `La teràpia ortomolecular és un enfocament que busca mantenir la salut i prevenir malalties a través de l'equilibri de les molècules en el cos, mitjançant la nutrició i l'ús de suplements. Es basa en la idea que moltes malalties poden ser tractades o previngudes corregint deficiències nutricionals i optimitzant la ingesta de vitamines, minerals i altres nutrients. Cada persona té necessitats úniques i, en personalitzar la dieta i els suplements, es pot millorar la salut general i el benestar.`,
  },
  {
    image: service3,
    title: `PsicoNeuroImmunoEndocrinologia`,
    text: `La psiconeuroinmunoendocrinología és una disciplina que estudia la interconnexió entre la ment (psicologia), el sistema nerviós, el sistema immunològic i el sistema endocrí. Se centra en com els pensaments, emocions i comportaments poden influir en la salut física i en la resposta del cos a malalties. Per exemple, l'estrès emocional pot afectar la funció immunològica i, al seu torn, la salut general. Aquesta àrea d'estudi cerca entendre com aquests sistemes interactuen i com es poden utilitzar aquests coneixements per a millorar el benestar i tractar diverses condicions de salut. És un camp fascinant que ressalta la connexió entre cos i ment.`,
  },
  {
    image: service4,
    title: `Terapia antiaging`,
    text: `La teràpia antiaging es refereix a un conjunt de tractaments i enfocaments dissenyats per a alentir el procés d'envelliment i millorar la qualitat de vida a mesura que les persones envelleixen.
L'envelliment és un procés fisiològic de deterioració de les funcions, òrgans i teixits de l'organisme. La teràpia antiaging és una medicina preventiva que suplementa les necessitats de l'organisme a mesura que envellim per a ajudar-nos a estar en les millors condicions. Aquesta medicina està indicada per a persones amb més de 35 anys que desitgen que la seva activitat física i mental millorin, mantenint les millors condicions físiques i intel·lectuals, prolongant la seva vida activa.`,
  },
  {
    image: service5,
    title: `Microinmunoteràpia`,
    text: `La microimmunoteràpia és un tractament dirigit a regular el sistema immunològic mitjançant la utilització de substàncies inmunomoduladores particularment interessants pel seu rol actiu en la regulació de la resposta immunitària. És un dels principals tractaments específics enfront de malalties relacionades amb el sistema immunitari.
El sistema immune ens defensa activament contra patògens com els virus i altres agents nocius però també és el responsable que tolerem elements estranys beneficiosos com són els aliments, la flora intestinal i fins i tot els teixits propis evitant mecanismes d'autoimmunitat. Així, en el seu òptim funcionament, és capaç de mantenir la balança entre aquestes respostes en el just equilibri.
La microimmunoteràpia representa una nova teràpia que no substitueix al sistema immunitari, ni el bloqueja ni el força, sinó que l'informa per a millorar-lo o corregir-lo, trobant d'aquesta manera la millor manera de respondre a les agressions. Aquesta informació se subministra al pacient directament a la xarxa limfàtica via sublingual, que és l'entrada natural i directa al sistema immunitari.`,
  },
];
...
export const contactFormData = {
  ...
  p: "Contacta'ns sense compromís mitjançant el formulari si vols comentar el teu cas personal o si vols tenir més informació sobre com treballo. Si ho prefereixes, també disposes de la opció d'escriure'm per whatsapp",
  formFields: {
    name: "Nom*",
    email: "Email*",
    message: "Missatge",
