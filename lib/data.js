...
export const homeData = {
  ...
  heroSubtitle: [
    "Us donem la benvinguda al nostre centre de naturopatia on us oferim Lorem ipsum ",
  ],
  linkHref: "/serveis",
...
export const footerData = {
  ...
  termes: {
    title: "Termes",
    items: [
      { href: "/termes-us", name: "Termes d'us" },
      { href: "/privacitat", name: "Política de privacitat" },
    ],
  },
};
