...
export const contactFormData = {
  ...
  p: "Contacta'ns sense compromís mitjançant el formulari si tens dubtes, vols comentar el teu cas personal o si vols tenir més informació sobre les teràpies que realitzo. O també, Si ho prefereixes, contacta'm a través de whatsapp, correo electronic o telèfon. ",
  formFields: {
    name: "Nom*",
    email: "Email*",
    message: "Missatge",
